...
var (
	...
	ErrUnauthorized   = errors.New("ops! to access this resource, you have to be logged in. please, log in or create a new account")
	ErrForbidden      = errors.New("ops! you don't have access to this resource. please, log in with an account that has it")
